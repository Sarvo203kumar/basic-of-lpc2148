...
#include <stdint.h>
#include <stdio.h>
#define en 10 // Define the pin connected to EN of the LCD
#define rs 12 // Define the pin connected to RS of the LCD
#define d4 16 // Define the pin connected to D4 of the LCD
#define d5 17 // Define the pin connected to D5 of the LCD
#define d6 18 // Define the pin connected to D6 of the LCD
#define d7 19 // Define the pin connected to D7 of the LCD
